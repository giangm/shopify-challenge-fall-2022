...
def delete():
    ...
    if item is None:
        ...
        # Insert item to be deleted into deleteitems table
        deleted_item = DeletedItems(item_id=item.id, item_name=item.item_name, item_quantity=item.item_quantity, comments=comments)
